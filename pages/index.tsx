  ...
  <>
    ...
    <div
      ...
      onClick={() => {
        var navbuttons = document.getElementById("navbuttons");
        if (
          window.getComputedStyle(navbuttons).display == "flex" &&
          window.getComputedStyle(document.getElementById("hambutton"))
            .display != "none"
        )
          navbuttons.style.display = "none";
      }}
      ...
      <div id="main" className="main">
        <div id="landingpage" className="landingpage">
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <text className="st">
              I am a developer interested in improving the world with the power
              of software
            </text>
          </div>
